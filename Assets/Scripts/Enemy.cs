...
public class Enemy : MonoBehaviour
{
    ...
    void FireShot()
    {
        ...
        for(int index = 0; index < 5; index++)
		{
            ...
            Vector2 ranVex = new Vector2(Random.Range(-0.5f, 0.5f), Random.Range(0f, 2f));
            dirVec += ranVex;
    ...
    void FireAround()
    {
        ...
        for(int index = 0; index < roundNumA; index++)
		{
            ...
            Vector3 rotVex = Vector3.forward * 360 * index / roundNumA + Vector3.forward * 90;
            bullet.transform.Rotate(rotVex);
        }
